...
# DAY 33:
# Currently matching with previous position.
# Next step: match using predicted position.
...
def predict_next_position(cx, cy,  prev_cx, prev_cy):
    vx = cx - prev_cx
    vy = cy - prev_cy
...
while True:
    ...
    for track_id,cx,cy,x1,y1,x2 ,y2 in tracked_persons: 
        ...
        if track_id in prev_centers:
            ...
            predicted_x, predicted_y = predict_next_position(cx ,cy ,prev_cx, prev_cy)
